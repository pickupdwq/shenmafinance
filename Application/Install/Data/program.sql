...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=22 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模型属性表' AUTO_INCREMENT=45 ;
...
INSERT INTO `category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `model_sub`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`, `groups`) VALUES
(1, 'course', '课程', 0, 0, 10, '', '', '', '', '', '', '', '2,3', '2', '2,1', 0, 0, 1, 0, 0, '1', '', 1379474947, 1451995338, 1, 0, ''),
(2, 'xiaozhuan', '小篆', 1, 1, 10, '', '', '', '', '', '', '', '2,3', '2', '2,1,3', 0, 1, 1, 0, 1, '1', '', 1379475028, 1451995348, 1, 0, '');
...
(1, 'WEB_SITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '习业', 0),
...
(13, 'COLOR_STYLE', 4, '后台色系', 1, 'default_color:默认\r\nblue_color:紫罗兰\r\nnew_color:灰色', '后台颜色风格', 1379122533, 1468388779, 1, 'new_color', 10),
...
INSERT INTO `document` (`id`, `uid`, `name`, `title`, `category_id`, `group_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
...
--
-- 转存表中的数据 `document_article`
--

INSERT INTO `document_article` (`id`, `parse`, `content`, `template`, `bookmark`) VALUES
...
(1, 'admin', 0, '0000-00-00', '', 20, 5, 0, 1451988550, 2130706433, 1468389241, 1);
...
(1, 'admin', 'e547adc177a951ce81101d5c67ded264', 'test@test.com', '', 1451988550, 0, 1468389241, 2130706433, 1451988550, 1);
